...
description: "Brief explanation of commonly agreed upon best practices in software engineering."
date: 2020-09-14
image: /assets/images/blog/140920/title.webp
minRead: 3
author:
  name: Aghil Jose
  avatar:
...
Best practices are a set of empirically proven approaches to software
...
![components](/assets/images/blog/140920/components.webp)
...
expecting changes during software development. It is also important to reach
an agreement with the user on what the software should do, not how to do it.
That is, after all, your job. Also always maintain forward and backward
traceability of the requirements.

## 2. Use Component-based Architecture
![control](/assets/images/blog/140920/control.webp)
...
![iterative](/assets/images/blog/140920/iterative.webp)

Always create objective milestones while creating a software. That will help
you concentrate on the small parts. But we also should never lose the context.
Critical risks should be resolved before making large investments. Initial
iterations will help us get early user feedback and this save the engineer
from making drastic changes at last while helping the engineer make sure
...
![manage](/assets/images/blog/140920/manage.webp)
...
measure. Once deployed, software issues are significantly costly to repair.
...
![verify](/assets/images/blog/140920/verify.webp)
...
smaller subsystems and responsibility of each should be assigned to a team. It
should be done in such a way that the changes made by one team affect other
teams the least or ideally, have none. Control mechanisms should be
established for change requests. These mechanisms should make sure the change
requests are the priority. The impact of the change request should always be
